...
const routes = [
    ...
    {
        path: 'privacy',
        loadChildren: () => __webpack_require__.e(/*! import() | privacy-privacy-module */ "privacy-privacy-module").then(__webpack_require__.bind(null, /*! ./privacy/privacy.module */ "./src/app/privacy/privacy.module.ts")).then(m => m.PrivacyPageModule)
    },
    {
        path: 'account',
    ...
    },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() | upadate-password-upadate-password-module */ "upadate-password-upadate-password-module").then(__webpack_require__.bind(null, /*! ./upadate-password/upadate-password.module */ "./src/app/upadate-password/upadate-password.module.ts")).then(m => m.UpadatePasswordPageModule)
    },
    {
        path: 'homepage',
        loadChildren: () => __webpack_require__.e(/*! import() | homepage-homepage-module */ "homepage-homepage-module").then(__webpack_require__.bind(null, /*! ./homepage/homepage.module */ "./src/app/homepage/homepage.module.ts")).then(m => m.HomepagePageModule)
    },
    {
        path: 'devices',
        loadChildren: () => __webpack_require__.e(/*! import() | devices-devices-module */ "devices-devices-module").then(__webpack_require__.bind(null, /*! ./devices/devices.module */ "./src/app/devices/devices.module.ts")).then(m => m.DevicesPageModule)
    },
    {
        path: 'notifications',
    ...
    {
        path: 'play',
        loadChildren: () => __webpack_require__.e(/*! import() | play-play-module */ "play-play-module").then(__webpack_require__.bind(null, /*! ./play/play.module */ "./src/app/play/play.module.ts")).then(m => m.PlayPageModule)
    },
    {
        path: 'stop',
        loadChildren: () => __webpack_require__.e(/*! import() | stop-stop-module */ "stop-stop-module").then(__webpack_require__.bind(null, /*! ./stop/stop.module */ "./src/app/stop/stop.module.ts")).then(m => m.StopPageModule)
    }
];
...
module.exports = __webpack_require__(/*! /Users/Victor/Documents/Projects/x-cite/src/main.ts */"./src/main.ts");
